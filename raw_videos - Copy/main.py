...
def camera():
    ...
    PATH = r"C:\Users\Asus\OneDrive\kosen2\signlent\data"
    ...
    with mp.solutions.holistic.Holistic(min_detection_confidence=0.75, min_tracking_confidence=0.75) as holistic:
        ...
        while cap.isOpened():
            ...
            if grammar_result:
                ...
                cv2.putText(uimage, grammar_result, (text_X_coord, 470),
                ...
                # Draw the sentence on the image
                cv2.putText(uimage, ' '.join(sentence), (text_X_coord, 470),
                            cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)

            # Show the image on the display
            cv2.imshow('Camera', uimage)
